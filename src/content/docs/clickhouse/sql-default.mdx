...
# SQL default
<Prerequisites>
- Quick start with Waddler - [read here](/docs/clickhouse/get-started/mysql-new)
...
Complete example with [`sql.identifier`](/docs/clickhouse/sql-identifier) and `sql.default`:
<Section>
```ts
