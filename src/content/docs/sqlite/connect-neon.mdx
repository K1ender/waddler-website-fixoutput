...
For an example of using Waddler with the Neon Serverless driver in a Cloudflare Worker, **[see here.](http://driz.link/neon-cf-ex)**  
To use Neon from a serverful environment, you can use the PostgresJS driver, as described in Neon's **[official Node.js docs](https://neon.tech/docs/guides/node)** — see **[docs](/docs/connect-postgresql)**.

#### Step 1 - Install packages
<Npm>
waddler @neondatabase/serverless
</Npm>
...
const sql = waddler({ client: sqlClient });
