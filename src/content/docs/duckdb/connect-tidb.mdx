...
- Waddler MySQL drivers - [docs](/docs/connect-mysql)
</Prerequisites>
...
TiDB Serverless is compatible with MySQL, so you can use [MySQL connection guide](/docs/connect-mysql) to connect to it.
</Callout>
